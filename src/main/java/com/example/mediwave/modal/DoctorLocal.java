...
@Entity
@Table(name="doctorlocal")
public class DoctorLocal {
	@Id
	...
	private String img;
	 ...
	 @ManyToOne
	    @JoinColumn(name="User_DoctorLocal")
	    private User user;
	...
	public DoctorLocal(long id_doctor, String acts_et_soins, String adresse, boolean featured, String genre,
